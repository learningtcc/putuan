...
public class NumberController extends BaseController {
    ...
    public JsonResult randomNumber(String type) {
        return new JsonResult(true).addData("number", getNumber(type));
    }

    private String getNumber(String type) {
        StringBuffer seqNumber = new StringBuffer(type).append(DateUtils.formatDate(new Date(), DateUtils.DateFormatType.DATE_FORMAT_FOREX));
