...
public class MpDeviceInfo {
    ...
    public MpDeviceInfo(Device device) {
        ...
        this.conn_strategy = device.getConnStrategy();
        this.crypt_method = device.getCryptMethod();
        this.auth_ver = device.getAuthVer();
        this.manu_mac_pos = device.getManuMacPos();
        this.ser_mac_pos = device.getSerMacPos();
        this.ble_simple_protocol = device.getBleSimpleProtocol();
    }
